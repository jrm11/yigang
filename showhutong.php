				...
				<div class="ind_box2 w1170">
					...
					<ul>
						 <?php
							...
							$sql='select * from `'.$tablepre.'pro_co` where `pass`="yes" and `lm`='.$rs['lm'].' and `pro_cs1`="'.$rs['pro_cs1'].'" and `pro_cs3`="'.$rs['pro_cs3'].'" and `huxing_lm`!=1 order by px desc,id asc limit 4';
							$result=$db->query($sql);
