							...
							<div class="r_con_r">
								...
								<?php
									...
									switch ($a){
										...
										case "a4":$dizhi='165'; break;
									}
									$sql='select * from `'.$tablepre.'pro_can_zs` where `fid`='.$dizhi.' order by id_lm asc  ';
									$result=$db->query($sql);
		...
		<div class="secHouse">
			...
			<div class="w1170">
				...
				<ul class="newHouse_ul">
					<?php
							$sqlcount='select count(*) from pro_co_zs where '.$sq.'';
							$sql='select * from `'.$tablepre.'pro_co_zs` where '.$sq.' order by '.$paixua.'';
