...
<html>
	...
	<body>
		...
		<div class="ind_box2 w1170">
			...
			<ul>
				<?php
					$sql='select * from pro_co_hz where lm=46 and tuijian=1 order by px desc,id desc limit 4';
					$result=$db->query($sql);
		...
		<div class="ind_box3">
			<div class="ind_box2 w1170">
				...
				<ul>
					<?php
						$sql='select * from pro_co_hz where lm=47 and tuijian=1 and huxing_lm=1 order by px desc,id desc limit 4';
						$result=$db->query($sql);
						while($rs=$db->getrow($result)){
							$aquyu='';
								switch ($rs['pro_cs1']){
		...
		<div class="ind_box2 w1170">
			...
			<ul>
				<?php
					$sql='select * from pro_co_hz where lm=48 and tuijian=1 order by px desc,id desc limit 4';
					$result=$db->query($sql);
					while($rs=$db->getrow($result)){
				?>
				<li>
