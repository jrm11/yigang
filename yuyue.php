...
<?php
	...
	if($act=="post"){
		...
		msg('留言成功，感谢您的留言','location="yuyue.php";');
	}
?>
<!DOCTYPE html>
<html>
	...
	<body>
		...
		<div class="weituo">
			<div class="weituo_nav">
				<a href="index.php">首页</a> / <a href="yuyue.php" title="资讯">预约看房</a>
			</div>
			<!---->
			<div class="weituo_form">
				<div class="weituo_form_nav">
					<div class="on">预约看房</div>
				</div>
				<ul class="weituo_form_con">
					<form name="form1" method="post" action="?act=post"> 
						...
						<li><div class="tit"><span class="red">*</span>预算：</div><div class="con"><input class="w225" type="text" name="jiage" placeholder="请填写您的预算" required/> 万元</div></li>
