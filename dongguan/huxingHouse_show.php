...
<?php
	...
	$sql='select * from pro_co_dg where id='.$id.' ';
	$result=$db->query($sql);
	$rs=$db->getrow($result);
	$rstitle=$rs['title'];
	...
	<body>
		...
		<div class="ny_banner hidePhone">
			...
			<div class="ny_banner_d">
				<a href="index.php">首页</a> / <a href="newHouse.php" title="新房源">新房源</a>
			</div>
		</div>
		<!--内页导航-->
		<div class="ny_nav">
			<div class="w1170">
				您当前位置：<a href="index.php">首页</a> &lt; <a href="newHouse.php">新房源</a> &lt; <?php echo $rstitle; ?>
			</div>
		</div>
		<!--banner结束-->
		<!--新房展示-->
			...
			<div class="house_show_box1">
						...
						<div class="magnifier-assembly">
							...
							<div class="magnifier-line">
								<ul class="clearfix animation03">
									<?php
										$sql='select `id`,`pro_id`,`big_img` from pro_img_dg where pro_id='.$id.' order by id asc';
										$result=$db->query($sql);
				...
				<div class="house_show_box1_r">
					...
					<div class="secHouse_t1">
						<?php echo $rs['pro_cs19']; ?> 万元
						<div><?php echo $rs['pro_cs20']; ?>元/m2</div>
					</div>
					<dl class="secHouse_mess"><dd><b><?php echo $rs['pro_cs14']; ?></b>户型</dd><dd><b><?php echo $rs['pro_cs18']; ?>㎡</b>建筑面积</dd><dd><b><?php echo $hc; ?></b>房屋朝向</dd></dl>
					<div>
					...
					<div class="jingjiren">
						...
						<div class="jingjiren_con">
							...
							<div class="phone"><?php echo $rsl['f_body']; ?> </div>
						</div>
