						...
						<div class="r_con">
							...
							<div class="r_con_r">
								...
								<?php
									$dizhi='1';
									switch ($a){
										case "a1":$dizhi='122';break;
										case "a2":$dizhi='123';break;
										case "a3":$dizhi='124'; break;
										case "a4":$dizhi='125'; break;
										case "a5":$dizhi='126';break;
										case "a6":$dizhi='127';break;
										case "a7":$dizhi='128';break;
										case "a8":$dizhi='67';break;
										case "a9":$dizhi='68';break;
										case "a0":$dizhi='69';break;
									}
									$sql='select * from `'.$tablepre.'pro_can_dg` where `fid`='.$dizhi.' order by id_lm asc  ';
									$result=$db->query($sql);
		...
		<div class="secHouse">
			...
			<div class="w1170">
				<div class="houseSort">排序：
						...
						<label for="paixu3" class="sort <?php if($paixu=="junjia"){echo 'on';}?>">总价</label>
						<label for="paixu4" class="sort <?php if($paixu=="kaipan"){echo 'on';}?>">均价</label>
						...
						<label for="ppaixu3" class="sort <?php if($paixu=="junjia"){echo 'on';}?>">总价</label>
						<label for="ppaixu4" class="sort <?php if($paixu=="kaipan"){echo 'on';}?>">均价</label>
				</div>
				<ul class="newHouse_ul">
					<?php
							$sqlcount='select count(*) from pro_co_dg where '.$sq.'';
							$sql='select * from `'.$tablepre.'pro_co_dg` where '.$sq.' order by '.$paixua.'';
					...
					?>
					<li>
						<a class="newHouse_ul_img" href="secHouse_show.php?id=<?php echo $row['id']; ?>"><img src="../<?php echo $row['img_sl']; ?>"/></a>
						<div class="newHouse_ul_con">
							<a class="t" href="secHouse_show.php?id=<?php echo $row['id']; ?>"><?php echo $row['title']; ?>
							...
							<div><?php echo $row['pro_cs11']; ?></div>
							<dl class="secHouse_mess"><dd><span>户型</span><b><?php echo $row['pro_cs14']; ?></b></dd><dd><span>建筑面积</span><b><?php echo $row['pro_cs18']; ?>㎡</b></dd><dd><span>房屋朝向</span><b><?php echo $hc; ?></b></dd></dl>
						...
						<div class="newHouse_ul_price"><div class="d1"><?php echo $row['pro_cs43']; ?>万<div class="d2"><?php echo $row['pro_cs44']; ?>元/㎡</div></div></div>
					</li>
					<?php
							}
						}
