...
$sql='insert into `'.$tablepre.'job_co` (`lm`,`title`,`color_font`,`uselink`,`link_url`,`info_from`,`info_author`,`f_body`,`z_body`,`img_sl`,`dow_sl`,`vid_sl`,`wtime`,`px`,`read_num`,`pass`,`tuijian`,`hot`,`ip`) values('.$lm.',"'.$title.'","'.$color_font.'","'.$uselink.'","'.$link_url.'","'.$info_from.'","'.$info_author.'","'.$f_body.'","'.$z_body.'","'.$img_sl.'","'.$dow_sl.'","'.$vid_sl.'",'.$wtime.','.$px.',0,"yes","no","no","'.getip().'")';
$db->execute($sql);
