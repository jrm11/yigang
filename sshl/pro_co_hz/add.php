	...
	<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
		...
		<tr class="tdbg">
			...
			<td><select name="lm" id="lm">
					...
					<option value="46" <?php if($lm==46){echo 'selected="selected"'; }?>>惠州二手房源</option>
					<option value="50" <?php if($lm==50){echo 'selected="selected"'; }?>>惠州二手学区房</option>
					<?php
		/*addlm(0,'');
		$db->close();
						...
						<td colspan="3">
							<tr>
								<div class="weizhi">
									...
									<div class="asd"><INPUT name="pro_cs1" type="radio" id="pro_can1" value="a2">惠州市区</div>
									<div class="asd"><INPUT name="pro_cs1" type="radio" id="pro_can1" value="a3">西北片区</div>
