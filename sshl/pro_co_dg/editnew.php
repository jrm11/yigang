...
$sqli='select * from `'.$tablepre.'pro_img` limit 1';
$resulti=$db->query($sqli);
$rowi=$db->getrows($resulti);
foreach($rowi as $key => $v){
	echo $v['sma_img'];
}
$db->freeresult($resulti);
?>
	...
	<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
		...
		<tr class="tdbg">
			...
			<td><select name="lm" id="lm">
					<option value="47" selected="selected">东莞新房源</option>
		...
		<tr class="tdbg2">
			<td width="120" align="right" class="red">检索选项：<?php echo $row['pro_cs1'].'<br/>'.$row['pro_can1'];?></td>
			<td><table border="0" cellspacing="0" cellpadding="2">
					<tr>
						<td colspan="3">
							<tr>
							<div class="weizhi">
								<div class="asd"><input name="pro_cs1" type="radio" id="pro_can1"  value="a1" <?php if(strstr($row['pro_cs1'],"a1")){echo 'checked';}?>>临深片区</div>
								<div class="asd"><input name="pro_cs1" type="radio" id="pro_can1" value="a2" <?php if(strstr($row['pro_cs1'],"a2")){echo 'checked';}?>>松山湖片区</div>
								<div class="asd"><input name="pro_cs1" type="radio" id="pro_can1" value="a3" <?php if(strstr($row['pro_cs1'],"a3")){echo 'checked';}?>>中心城区</div>
								<div class="asd"><input name="pro_cs1" type="radio" id="pro_can1" value="a5" <?php if(strstr($row['pro_cs1'],"a5")){echo 'checked';}?>>水乡片区</div>
								<div class="asd"><input name="pro_cs1" type="radio" id="pro_can1" value="a6" <?php if(strstr($row['pro_cs1'],"a6")){echo 'checked';}?>>大石龙片区</div>
								<div class="asd"><input name="pro_cs1" type="radio" id="pro_can1" value="a7" <?php if(strstr($row['pro_cs1'],"a7")){echo 'checked';}?>>东北片区</div>
								<div class="asd"><input name="pro_cs1" type="radio" id="pro_can1" value="a8" <?php if(strstr($row['pro_cs1'],"a8")){echo 'checked';}?>>长安片区</div>
								<div class="asd"><input name="pro_cs1" type="radio" id="pro_can1" value="a9" <?php if(strstr($row['pro_cs1'],"a9")){echo 'checked';}?>>虎门片区</div>
