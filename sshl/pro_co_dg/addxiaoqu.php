...
<FORM name="form1" id="form1" method="post" action="addd.php" onSubmit="return check()">
	<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
		...
		<tr class="tdbg">
			...
			<td><INPUT name="pro_cs40" type="text" id="pro_can1" size="30" maxlength="80"></td>
		</tr>
		<tr class="tdbg2">
			...
			<td><table border="0" cellspacing="0" cellpadding="2">
					<tr>
						<td>每平米售价：</td>
						<td><INPUT name="pro_cs44" type="text" id="pro_can4"  maxlength="50" required="required">
							元/㎡</td>
					</tr>
					<tr>
						<td>建筑年代：</td>
						<td><INPUT name="pro_cs39" type="text" id="pro_can3"  maxlength="50" /></td>
					</tr>
					<tr>
						<td>物业用途：</td>
						<td><INPUT name="pro_cs38" type="text" id="pro_can3"  maxlength="50"></td>
						<td>产权性质：</td>
						<td><INPUT name="pro_cs37" type="text" id="pro_can3"  maxlength="50" /></td>
					</tr>
					<tr>
						<td>建筑结构：</td>
						<td><INPUT name="pro_cs29" type="text" id="pro_can3"  maxlength="50"></td>
						<td>规划户数：</td>
						<td><INPUT name="pro_cs28" type="text" id="pro_can3"  maxlength="50" /></td>
					</tr>
					<tr>
						<td>车位个数：</td>
						<td><INPUT name="pro_cs36" type="text" id="pro_can3"  maxlength="50"></td>
						<td>占地面积：</td>
						<td><INPUT name="pro_cs35" type="text" id="pro_can3"  maxlength="50" /></td>
					</tr>
					<tr>
						<td>容积比率：</td>
						<td><INPUT name="pro_cs34" type="text" id="pro_can3"  maxlength="50"></td>
						<td>绿化情况：</td>
						<td><INPUT name="pro_cs33" type="text" id="pro_can3"  maxlength="50" /></td>
					</tr>
					<tr>
						<td>水电煤气：</td>
						<td><INPUT name="pro_cs32" type="text" id="pro_can3"  maxlength="50"></td>
						<td>物业费用：</td>
						<td><INPUT name="pro_cs31" type="text" id="pro_can3"  maxlength="50" /></td>
					</tr>
					<tr>
						<td>供暖方式：</td>
						<td><INPUT name="pro_cs30" type="text" id="pro_can3"  maxlength="50"/></td>
					</tr>
				</table></td>
		</tr>
		<tr class="tdbg">
			...
			<td > 小区简介：<br/>
				<textarea name="pro_cs15" rows="4" id="pro_cs15" style="width:574px;"></textarea>
				<br/>
				交通配套：<br/>
				<textarea name="pro_cs16" rows="4" id="pro_cs16" style="width:574px;"></textarea>
				<br/></td>
		</tr>
		<tr class="tdbg">
