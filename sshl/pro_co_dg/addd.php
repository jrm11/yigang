...
$sql='insert into `'.$tablepre.'pro_co_dg` (`lm`,`title`,`pro_can1`,`pro_can2`,`pro_can3`,`pro_can4`,`f_body`,`z_body`,`z_body1`,`img_sl`,`px`,`read_num`,`pass`,`tuijian`,`hot`,`wtime`,`ip`,`pro_cs1`,`pro_cs2`,`pro_cs3`,`pro_cs4`,`pro_cs5`,`pro_cs6`,`pro_cs7`,`pro_cs8`,`pro_cs9`,`pro_cs10`,`pro_cs11`,`pro_cs12`,`pro_cs13`,`pro_cs14`,`pro_cs15`,`pro_cs16`,`pro_cs17`,`pro_cs18`,`pro_cs19`,`pro_cs20`,`pro_cs21`,`pro_cs22`,`pro_cs23`,`pro_cs24`,`pro_cs25`,`pro_cs26`,`pro_cs27`,`pro_cs28`,`pro_cs29`,`pro_cs30`,`pro_cs31`,`pro_cs32`,`pro_cs33`,`pro_cs34`,`pro_cs35`,`pro_cs36`,`pro_cs37`,`pro_cs38`,`pro_cs39`,`pro_cs40`,`pro_cs41`,`pro_cs42`,`pro_cs43`,`pro_cs44`,`pro_cs45`,`pro_cs46`,`pro_cs47`,`pro_cs48`,`pro_cs49`,`pro_cs50`,`jing`,`jingjiren`,`huxing_lm`) values('.$lm.',"'.$title.'","'.$pro_can1.'","'.$pro_can2.'","'.$pro_can3.'","'.$pro_can4.'","'.$f_body.'","'.$z_body.'","'.$z_body1.'","'.$img_sl.'",'.$px.',0,"yes","0","0",'.time().',"'.getip().'","'.$pro_cs1.'","'.$pro_cs2.'","'.$pro_cs3.'","'.$pro_cs4.'","'.$pro_cs5.'","'.$pro_cs6str.'","'.$pro_cs7.'","'.$pro_cs8.'","'.$pro_cs9.'","'.$pro_cs10.'","'.$pro_cs11.'","'.$pro_cs12.'","'.$pro_cs13.'","'.$pro_cs14.'","'.$pro_cs15.'","'.$pro_cs16.'","'.$pro_cs17.'",'.$pro_cs18.',"'.$pro_cs19.'","'.$pro_cs20.'","'.$pro_cs21.'","'.$pro_cs22.'","'.$pro_cs23.'","'.$pro_cs24.'","'.$pro_cs25.'","'.$pro_cs26.'","'.$pro_cs27.'","'.$pro_cs28.'","'.$pro_cs29.'","'.$pro_cs30.'","'.$pro_cs31.'","'.$pro_cs32.'","'.$pro_cs33.'","'.$pro_cs34.'","'.$pro_cs35.'","'.$pro_cs36.'","'.$pro_cs37.'","'.$pro_cs38.'","'.$pro_cs39.'","'.$pro_cs40.'","'.$pro_cs41str.'",'.$pro_cs42.','.$pro_cs43.','.$pro_cs44.','.$pro_cs45.','.$pro_cs46.','.$pro_cs47.','.$pro_cs48.','.$pro_cs49.','.$pro_cs50.',"0","'.$jingjiren.'","'.$huxing.'")';
$db->execute($sql);

$pr_id=$db->insert_id();
if (isset($_SESSION['p_id'])&&$_SESSION['p_id']!=''&&checknum($_SESSION['p_id'])){
	$db->execute('update pro_img_dg set pro_id='.$pr_id.' where pro_id='.$_SESSION['p_id'].'');
	$_SESSION['p_id']='';
}
