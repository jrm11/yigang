...
<FORM name="form1" id="form1" method="post" action="addd.php" onSubmit="return check()">
	<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
			...
			<td><table border="0" cellspacing="0" cellpadding="2">
				<tr>
						<td colspan="3">
							<tr>
								<div class="weizhi">
									<div class="asd"><INPUT name="pro_cs1" type="radio" id="pro_can1"  value="a1">临深片区</div>
									<div class="asd"><INPUT name="pro_cs1" type="radio" id="pro_can1"  value="a2">松山湖片区</div>
									<div class="asd"><INPUT name="pro_cs1" type="radio" id="pro_can1"  value="a3">中心城区</div>
									<div class="asd"><INPUT name="pro_cs1" type="radio" id="pro_can1"  value="a5">水乡片区</div>
									<div class="asd"><INPUT name="pro_cs1" type="radio" id="pro_can1"  value="a6">大石龙片区</div>
									<div class="asd"><INPUT name="pro_cs1" type="radio" id="pro_can1"  value="a7">东北片区</div>
									<div class="asd"><INPUT name="pro_cs1" type="radio" id="pro_can1"  value="a8">长安片区</div>
									<div class="asd"><INPUT name="pro_cs1" type="radio" id="pro_can1"  value="a9">虎门片区</div>
					...
					<tr>
						<td>户型：</td>
						<td colspan="3"><div class="asd">
								<INPUT name="pro_cs41[]" type="checkbox" id="pro_can1" value="e1"<?php if(strstr($pro_cs41,"e1")){echo 'checked';}?>>
								一室</div>
							<div class="asd">
								<INPUT name="pro_cs41[]" type="checkbox" id="pro_can1" value="e2"<?php if(strstr($pro_cs41,"e2")){echo 'checked';}?>>
								二室</div>
							<div class="asd">
								<INPUT name="pro_cs41[]" type="checkbox" id="pro_can1" value="e3"<?php if(strstr($pro_cs41,"e3")){echo 'checked';}?>>
								三室</div>
							<div class="asd">
								<INPUT name="pro_cs41[]" type="checkbox" id="pro_can1" value="e4"<?php if(strstr($pro_cs41,"e4")){echo 'checked';}?>>
								四室</div>
							<div class="asd">
								<INPUT name="pro_cs41[]" type="checkbox" id="pro_can1" value="e5"<?php if(strstr($pro_cs41,"e5")){echo 'checked';}?>>
								五室以上</div>
							<div class="asd">
								<INPUT name="pro_cs41[]" type="checkbox" id="pro_can1" value="e6"<?php if(strstr($pro_cs41,"e6")){echo 'checked';}?>>
								别墅</div>
		...
		<tr class="tdbg">
			...
			<td>楼盘名称：
				<INPUT name="pro_cs11" type="text" id="pro_can1" size="30" maxlength="80">
				<br/>
				楼盘别名：
				<INPUT name="pro_cs12" type="text" id="pro_can1" size="30" maxlength="80"></td>
		</tr>
		<tr class="tdbg">
		...
		<tr class="tdbg2">
			...
			<td><table border="0" cellspacing="0" cellpadding="2">
					<tr>
						<td>户型：</td>
						<td><INPUT name="pro_cs14" type="text" id="pro_can1"  maxlength="200"></td>
					</tr>
					<tr>
						<td>每平米售价：</td>
						<td><INPUT name="pro_cs18" type="text" id="pro_can4"  maxlength="50"required="required">
							元/平方米</td>
					</tr>
					<tr>
						<td>开盘时间：</td>
						<td><input name="pro_cs45" type="text" id="wtime" value="<?php echo date('Y-m-d')?>" maxlength="50"required="required">
							时间格式为“年-月-日</td>
						<td>交房时间：</td>
						<td><input name="pro_cs46" type="text" id="wtime" value="<?php echo date('Y-m-d')?>" maxlength="50"required="required">
							时间格式为“年-月-日</td>
					</tr>
					<tr>
						<td>产 权：</td>
						<td><INPUT name="pro_cs21" type="text" id="pro_can3"  maxlength="50"></td>
						<td>物业公司：</td>
						<td><INPUT name="pro_cs22" type="text" id="pro_can4"  maxlength="50"></td>
					</tr>
					<tr>
						<td>容 积 率：</td>
						<td><INPUT name="pro_cs23" type="text" id="pro_can3"  maxlength="50"></td>
						<td>建筑类型：</td>
						<td><INPUT name="pro_cs24" type="text" id="pro_can4"  maxlength="50"></td>
					</tr>
					<tr>
						<td>规划户数：</td>
						<td><INPUT name="pro_cs25" type="text" id="pro_can3"  maxlength="50"></td>
						<td>停 车 位：</td>
						<td><INPUT name="pro_cs26" type="text" id="pro_can4"  maxlength="50"></td>
					</tr>
					<tr>
						<td>物业费用：</td>
						<td><INPUT name="pro_cs27" type="text" id="pro_can3"  maxlength="50"></td>
						<td>建筑面积：</td>
						<td><INPUT name="pro_cs28" type="text" id="pro_can4"  maxlength="50"></td>
					</tr>
					<tr>
						<td>开 发 商：</td>
						<td><INPUT name="pro_cs29" type="text" id="pro_can3"  maxlength="50"></td>
						<td>物业类型：</td>
						<td><INPUT name="pro_cs30" type="text" id="pro_can4"  maxlength="50"></td>
					</tr>
					<tr>
						<td>绿 化 率：</td>
						<td><INPUT name="pro_cs31" type="text" id="pro_can3"  maxlength="50"></td>
						<td>占地面积：</td>
						<td><INPUT name="pro_cs32" type="text" id="pro_can4"  maxlength="50"></td>
					</tr>
				</table></td>
		</tr>
		<tr class="tdbg">
