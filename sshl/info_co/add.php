...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
  ...
  <tr  class="tdbg" id="dis_uselink" style="display:none;" >
    ...
    <td>
    <input name="link_url" type="text" id="link_url" size="57" maxlength="150" value="http://">
    </td>
  </tr>
  ...
  <tr class="tdbg" id="dis_z_body" style="display:none;">
    ...
    <td>
    <script id="editor" name="z_body" type="text/plain" style="width:700px;height:400px;"></script>
    </td>
  </tr>
  <tr class="tdbg" id="dis_img_sl" style="display:none;">          
    <td width="120" align="right">图片上传：</td>          
    <td ><IFRAME style="margin-top:2px;"height=22 src="up.php?frameid=frame1&kuang=img_sl" width="380" frameborder=0  scrolling=no  name="frame1" id="frame1"></iframe><input type="hidden" name="img_sl" id="img_sl"></td>
  </tr>
    <tr class="tdbg" id="dis_dow_sl" style="display:none;">          
        <td width="120" align="right">图片二上传：</td>          
        <td ><IFRAME name="frame2" id="frame2" style="margin-top:2px;"height=22 src="upd.php?frameid=frame2&kuang=dow_sl" width="380" frameborder=0  scrolling=no  ></iframe><input type="hidden" name="dow_sl" id="dow_sl"></td>
    </tr>
    <tr class="tdbg" id="dis_vid_sl" style="display:none;">          
        <td width="120" align="right">视频上传：</td>          
        <td ><IFRAME name="frame3" id="frame3" style="margin-top:2px;"height=22 src="upv.php?frameid=frame3&kuang=vid_sl" width="380" frameborder=0  scrolling=no  ></iframe><input type="hidden" name="vid_sl" id="vid_sl"></td>
    </tr>
  <tr class="tdbg" id="dis_wtime">
    <td width="120" align="right">发布时间：</td>
    <td ><input name="wtime" type="text" id="wtime" value="<?php echo date('Y-m-d H:i:s')?>" maxlength="50">              时间格式为“年-月-日 时:分:秒”，如：<font color="#0000FF">2016-5-7 15:30:12</font></td>
  </tr>
  <tr class="tdbg">
