	...
	<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
		...
		<tr class="tdbg">
			...
			<td><select name="huxing" id="huxing">
					<?php
						$sql_ser='select * from `'.$tablepre.'pro_co` where `lm`=47 and huxing_lm=1 order by px desc,id desc  ';
						$result_ser=$db->query($sql_ser);
						$huxing_lm=$row['huxing_lm'];
						while ($row_ser=$db->getrow($result_ser)){
					?>
					<option value="<?php echo $row_ser['id']; ?>" <?php if($row_ser['id']==$huxing_lm){ echo ' selected="selected"'; }?> ><?php echo $row_ser['title']; ?></option>
					<?php
						}
		...
		<tr class="tdbg2">
			...
			<td><table border="0" cellspacing="0" cellpadding="2">
					<tr>
						<td>户型：</td>
						<td><INPUT name="pro_cs14" type="text" id="pro_can1"  maxlength="50" value="<?php echo $row['pro_cs14']; ?>"></td>
						<td>面积：</td>
					...
					<tr>
						<td>售价：</td>
						<td><INPUT name="pro_cs19" type="text" id="pro_can3"  maxlength="50" value="<?php echo $row['pro_cs19']; ?>">
							万</td>
						<td>每平米售价：</td>
						<td><INPUT name="pro_cs20" type="text" id="pro_can4"  maxlength="50" value="<?php echo $row['pro_cs20']; ?>">
							元/㎡</td>
					</tr>
					<tr>
						<td>套内面积：</td>
						<td><INPUT name="pro_cs21" type="text" id="pro_can3"  maxlength="50" value="<?php echo $row['pro_cs21']; ?>">
							㎡</td>
					</tr>
					<tr>
						<td>楼层高度：</td>
		...
		<tr class="tdbg">
			...
			<td > 房源亮点：<br/>
				<textarea name="pro_cs17" rows="4" id="pro_can1" style="width:574px;"><?php echo rehtml($row['pro_cs17'])?></textarea>
				<br/></td>
		</tr>
		<tr class="tdbg">
