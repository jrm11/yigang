	...
	<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
		...
		<tr class="tdbg">
			...
			<td><select name="lm" id="lm">
					<option value="49" selected=" selected">深圳二手小区房</option>
		...
		<tr class="tdbg">
			<td width="120" align="right">开发商名：</td>
			<td><INPUT name="pro_cs13" type="text" id="pro_can1" size="30" maxlength="80" value="<?php echo $row['pro_cs13']; ?>"></td>
		</tr>
		<tr class="tdbg">
			<td width="120" align="right">物业公司：</td>
			<td><INPUT name="pro_cs40" type="text" id="pro_can1" size="30" maxlength="80" value="<?php echo $row['pro_cs13']; ?>"></td>
		</tr>
		<tr class="tdbg2">
			...
			<td><table border="0" cellspacing="0" cellpadding="2">
					<tr>
						<td>每平米售价：</td>
						<td><INPUT name="pro_cs44" type="text" id="pro_can4"  maxlength="50" value="<?php echo $row['pro_cs44']; ?>">
							元/㎡</td>
					</tr>
					<tr>
						<td>建筑年代：</td>
						<td><INPUT name="pro_cs39" type="text" id="pro_can3"  maxlength="50" value="<?php echo $row['pro_cs39']; ?>"></td>
					</tr>
					<tr>
						<td>物业用途：</td>
						<td><INPUT name="pro_cs38" type="text" id="pro_can3"  maxlength="50" value="<?php echo $row['pro_cs38']; ?>"></td>
						<td>产权性质：</td>
						<td><INPUT name="pro_cs37" type="text" id="pro_can3"  maxlength="50" value="<?php echo $row['pro_cs37']; ?>"></td>
					</tr>
					<tr>
						<td>建筑结构：</td>
						<td><INPUT name="pro_cs29" type="text" id="pro_can3"  maxlength="50" value="<?php echo $row['pro_cs29']; ?>"></td>
						<td>规划户数：</td>
						<td><INPUT name="pro_cs28" type="text" id="pro_can3"  maxlength="50" value="<?php echo $row['pro_cs28']; ?>"></td>
					</tr>
					<tr>
						<td>车位个数：</td>
						<td><INPUT name="pro_cs36" type="text" id="pro_can3"  maxlength="50" value="<?php echo $row['pro_cs36']; ?>"></td>
						<td>占地面积：</td>
						<td><INPUT name="pro_cs35" type="text" id="pro_can3"  maxlength="50" value="<?php echo $row['pro_cs35']; ?>"></td>
					</tr>
					<tr>
						<td>容积比率：</td>
						<td><INPUT name="pro_cs34" type="text" id="pro_can3"  maxlength="50" value="<?php echo $row['pro_cs34']; ?>"></td>
						<td>绿化情况：</td>
						<td><INPUT name="pro_cs33" type="text" id="pro_can3"  maxlength="50" value="<?php echo $row['pro_cs33']; ?>"></td>
					</tr>
					<tr>
						<td>水电煤气：</td>
						<td><INPUT name="pro_cs32" type="text" id="pro_can3"  maxlength="50" value="<?php echo $row['pro_cs32']; ?>"></td>
						<td>物业费用：</td>
						<td><INPUT name="pro_cs31" type="text" id="pro_can3"  maxlength="50" value="<?php echo $row['pro_cs31']; ?>"></td>
					</tr>
					<tr>
						<td>供暖方式：</td>
						<td><INPUT name="pro_cs30" type="text" id="pro_can3"  maxlength="50" value="<?php echo $row['pro_cs30']; ?>"></td>
					</tr>
				</table></td>
		</tr>
		<tr class="tdbg">
			...
			<td > 小区简介：<br/>
				<textarea name="pro_cs15" rows="4" id="pro_can1" style="width:574px;"><?php echo rehtml($row['pro_cs15'])?></textarea>
				<br/>
				交通配套：<br/>
				<textarea name="pro_cs16" rows="4" id="pro_can1" style="width:574px;"><?php echo rehtml($row['pro_cs16'])?></textarea>
				<br/></td>
		</tr>
		<tr class="tdbg">
