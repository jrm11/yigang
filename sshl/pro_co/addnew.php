							...
							<tr>
								<div class="weizhi">
									...
									<div class="asd">
										...
										宝安</div>
									<div class="asd">
										<INPUT name="pro_cs1" type="radio" id="pro_can1" value="a5">
										龙岗</div>
									<div class="asd">
										<INPUT name="pro_cs1" type="radio" id="pro_can1" value="a6">
										龙华新区</div>
									<div class="asd">
										<INPUT name="pro_cs1" type="radio" id="pro_can1" value="a7">
										光明新区</div>
									<div class="asd">
										<INPUT name="pro_cs1" type="radio" id="pro_can1" value="a8">
										盐田</div>
									<div class="asd">
										<INPUT name="pro_cs1" type="radio" id="pro_can1" value="a9">
										坪山新区</div>
									<div class="asd">
										<INPUT name="pro_cs1" type="radio" id="pro_can1" value="a0">
										大鹏新区</div>
