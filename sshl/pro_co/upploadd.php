...
if($ac==''){
	if($img_sl==''){
		echo'<script>location="upp.php?frameid='.$frameid.'&kuang='.$kuang.'"</script>';
	}else{
		echo'&nbsp;<img src="../images/img.gif" onmouseover="popImage(this,\'../../'.$img_sl.'\');" onmouseout="hideLayer();">　<a href="upploadd.php?frameid='.$frameid.'&kuang='.$kuang.'&img_sl='.$img_sl.'&ac=del" onclick="return confirm(\'确定要删除文件吗？\')">删除文件,重新上传</a>';
	}
}elseif($ac=='del'){
	if($img_sl!=''){
		delfile($img_sl);
