	...
	<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
		...
		<tr class="tdbg">
			...
			<td><select name="lm" id="lm">
					<option value="1"  <?php if($lm==''){echo 'selected="selected"'; }?>>选择房源分类</option>
					<option value="46" <?php if($lm==46){echo 'selected="selected"'; }?>>深圳二手房源</option>
					<option value="50" <?php if($lm==50){echo 'selected="selected"'; }?>>深圳二手学区房</option>
			...
			<td><table border="0" cellspacing="0" cellpadding="2">
					<tr>
						<td colspan="3">
							<tr>
								<div class="weizhi">
									<div class="asd"><INPUT name="pro_cs1" type="radio" id="pro_can1" value="a1">南山</div>
									<div class="asd"><INPUT name="pro_cs1" type="radio" id="pro_can1" value="a2">福田</div>
									<div class="asd"><INPUT name="pro_cs1" type="radio" id="pro_can1" value="a3">罗湖</div>
									<div class="asd"><INPUT name="pro_cs1" type="radio" id="pro_can1" value="a4">宝安</div>
									<div class="asd"><INPUT name="pro_cs1" type="radio" id="pro_can1" value="a5">龙岗</div>
									<div class="asd"><INPUT name="pro_cs1" type="radio" id="pro_can1" value="a6">龙华新区</div>
									<div class="asd"><INPUT name="pro_cs1" type="radio" id="pro_can1" value="a7">光明新区</div>
									<div class="asd"><INPUT name="pro_cs1" type="radio" id="pro_can1" value="a8">盐田</div>
									<div class="asd"><INPUT name="pro_cs1" type="radio" id="pro_can1" value="a9">坪山新区</div>
									<div class="asd"><INPUT name="pro_cs1" type="radio" id="pro_can1" value="a0">大鹏新区</div>
					...
					<tr>
						...
						<td colspan="3"><div class="asd">
								...
								满两年</div>
							<div class="asd">
								<INPUT name="pro_cs6[]" type="checkbox" id="pro_can1" value="f12"<?php if(strstr($pro_cs6,"f12")){echo 'checked';}?>>
								满五唯一</div>
							<div class="asd">
		...
		<tr class="tdbg2">
			...
			<td><table border="0" cellspacing="0" cellpadding="2">
					...
					<tr>
						<td>售价：</td>
						<td><INPUT name="pro_cs43" type="text" id="pro_can3"  maxlength="50" required="required">
							万</td>
						<td>每平米售价：</td>
		...
		<tr class="tdbg">
			<td width="120" align="right">小区简介：</td>
