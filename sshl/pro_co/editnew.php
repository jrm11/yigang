	...
	<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
		...
		<tr class="tdbg">
			...
			<td><select name="lm" id="lm">
					<option value="47" selected="selected">深圳新房源</option>
		...
		<tr class="tdbg">
			<td width="120" align="right">楼盘名称：</td>
			...
			<td><table border="0" cellspacing="0" cellpadding="2">
					<tr>
						<td colspan="3">
							...
							<div class="weizhi">
								...
								<div class="asd">
									...
									宝安</div>
								<div class="asd">
									<INPUT name="pro_cs1" type="radio" id="pro_can1" value="a5" <?php if(strstr($row['pro_cs1'],"a5")){echo 'checked';}?>>
									龙岗</div>
								<div class="asd">
									<INPUT name="pro_cs1" type="radio" id="pro_can1" value="a6" <?php if(strstr($row['pro_cs1'],"a6")){echo 'checked';}?>>
									龙华新区</div>
								<div class="asd">
									<INPUT name="pro_cs1" type="radio" id="pro_can1" value="a7" <?php if(strstr($row['pro_cs1'],"a7")){echo 'checked';}?>>
									光明新区</div>
								<div class="asd">
									<INPUT name="pro_cs1" type="radio" id="pro_can1" value="a8" <?php if(strstr($row['pro_cs1'],"a8")){echo 'checked';}?>>
									盐田</div>
								<div class="asd">
									<INPUT name="pro_cs1" type="radio" id="pro_can1" value="a9" <?php if(strstr($row['pro_cs1'],"a9")){echo 'checked';}?>>
									坪山新区</div>
								<div class="asd">
									<INPUT name="pro_cs1" type="radio" id="pro_can1" value="a0" <?php if(strstr($row['pro_cs1'],"a0")){echo 'checked';}?>>
									大鹏新区</div>
						...
						<tr>
							<div class="ditie">
								<div class="asd">
									<INPUT name="pro_cs2" type="radio" id="pro_can1" value="b10" <?php if(strstr($row['pro_cs2'],"b10")){echo 'checked';}?>>
									罗宝线</div>
								<div class="asd">
									<INPUT name="pro_cs2" type="radio" id="pro_can1" value="b11"<?php if(strstr($row['pro_cs2'],"b11")){echo 'checked';}?>>
									蛇口线</div>
								<div class="asd">
									<INPUT name="pro_cs2" type="radio" id="pro_can1" value="b12"<?php if(strstr($row['pro_cs2'],"b12")){echo 'checked';}?>>
									龙岗线</div>
								<div class="asd">
									<INPUT name="pro_cs2" type="radio" id="pro_can1" value="b13"<?php if(strstr($row['pro_cs2'],"b13")){echo 'checked';}?>>
									龙华线</div>
								<div class="asd">
									<INPUT name="pro_cs2" type="radio" id="pro_can1" value="b14"<?php if(strstr($row['pro_cs2'],"b14")){echo 'checked';}?>>
									环中线</div>
								<div class="asd">
									<INPUT name="pro_cs2" type="radio" id="pro_can1" value="b15"<?php if(strstr($row['pro_cs2'],"b15")){echo 'checked';}?>>
									机场专线</div>
								<div class="asd">
									<INPUT name="pro_cs2" type="radio" id="pro_can1" value="b16"<?php if(strstr($row['pro_cs2'],"b16")){echo 'checked';}?>>
									西丽线</div>
								<div class="asd">
									<INPUT name="pro_cs2" type="radio" id="pro_can1" value="b17"<?php if(strstr($row['pro_cs2'],"b17")){echo 'checked';}?>>
									梅林线</div>
								<div class="asd">
									<INPUT name="pro_cs2" type="radio" id="pro_can1" value="b18"<?php if(strstr($row['pro_cs2'],"b18")){echo 'checked';}?>>
									光明线</div>
								<div class="asd">
									<INPUT name="pro_cs2" type="radio" id="pro_can1" value="b19"<?php if(strstr($row['pro_cs2'],"b19")){echo 'checked';}?>>
									坂田线</div>
					...
					<tr>
						<td>户型：</td>
						<td colspan="3"><div class="asd">
								<INPUT name="pro_cs41[]" type="checkbox" id="pro_can1" value="e1"<?php if(strstr($row['pro_cs41'],"e1")){echo 'checked';}?>>
								一室</div>
							<div class="asd">
								<INPUT name="pro_cs41[]" type="checkbox" id="pro_can1" value="e2"<?php if(strstr($row['pro_cs41'],"e2")){echo 'checked';}?>>
								二室</div>
							<div class="asd">
								<INPUT name="pro_cs41[]" type="checkbox" id="pro_can1" value="e3"<?php if(strstr($row['pro_cs41'],"e3")){echo 'checked';}?>>
								三室</div>
							<div class="asd">
								<INPUT name="pro_cs41[]" type="checkbox" id="pro_can1" value="e4"<?php if(strstr($row['pro_cs41'],"e4")){echo 'checked';}?>>
								四室</div>
							<div class="asd">
								<INPUT name="pro_cs41[]" type="checkbox" id="pro_can1" value="e5"<?php if(strstr($row['pro_cs41'],"e5")){echo 'checked';}?>>
								五室以上</div>
							<div class="asd">
								<INPUT name="pro_cs41[]" type="checkbox" id="pro_can1" value="e6"<?php if(strstr($row['pro_cs41'],"e6")){echo 'checked';}?>>
								别墅</div>
		...
		<tr class="tdbg">
			...
			<td>楼盘名称：
				<INPUT name="pro_cs11" type="text" id="pro_can1" size="30" maxlength="80" value="<?php echo $row['pro_cs11'];?>">
				<br/>
				楼盘别名：
				<INPUT name="pro_cs12" type="text" id="pro_can1" size="30" maxlength="80" value="<?php echo $row['pro_cs12'];?>"></td>
		</tr>
		<tr class="tdbg">
			<td width="120" align="right">楼盘地址：</td>
			<td><INPUT name="pro_cs13" type="text" id="pro_can1" size="30" maxlength="80" value="<?php echo $row['pro_cs13'];?>"></td>
		</tr>
		<tr class="tdbg2">
			...
			<td><table border="0" cellspacing="0" cellpadding="2">
					<tr>
						<td>户型：</td>
						<td><INPUT name="pro_cs14" type="text" id="pro_can1"  maxlength="200" value="<?php echo $row['pro_cs14'];?>"></td>
					</tr>
					<tr>
						<td>每平米售价：</td>
						<td><INPUT name="pro_cs18" type="text" id="pro_can4"  maxlength="50" value="<?php echo $row['pro_cs18'];?>">
							元/平方米</td>
					</tr>
					<tr>
						<td>开盘时间：</td>
						<td><input name="pro_cs45" type="text" id="wtime" value="<?php echo date('Y-m-d',$row['pro_cs45'])?>" maxlength="50"></td>
						<td>交房时间：</td>
						<td><input name="pro_cs46" type="text" id="wtime" value="<?php echo date('Y-m-d',$row['pro_cs46'])?>" maxlength="50"></td>
					</tr>
					<tr>
						<td>产 权：</td>
						<td><INPUT name="pro_cs21" type="text" id="pro_can3"  maxlength="50" value="<?php echo $row['pro_cs21'];?>"></td>
						<td>物业公司：</td>
						<td><INPUT name="pro_cs22" type="text" id="pro_can4"  maxlength="50" value="<?php echo $row['pro_cs22'];?>"></td>
					</tr>
					<tr>
						<td>容 积 率：</td>
						<td><INPUT name="pro_cs23" type="text" id="pro_can3"  maxlength="50" value="<?php echo $row['pro_cs23'];?>"></td>
						<td>建筑类型：</td>
						<td><INPUT name="pro_cs24" type="text" id="pro_can4"  maxlength="50" value="<?php echo $row['pro_cs24'];?>"></td>
					</tr>
					<tr>
						<td>规划户数：</td>
						<td><INPUT name="pro_cs25" type="text" id="pro_can3"  maxlength="50" value="<?php echo $row['pro_cs25'];?>"></td>
						<td>停 车 位：</td>
						<td><INPUT name="pro_cs26" type="text" id="pro_can4"  maxlength="50" value="<?php echo $row['pro_cs26'];?>"></td>
					</tr>
					<tr>
						<td>物业费用：</td>
						<td><INPUT name="pro_cs27" type="text" id="pro_can3"  maxlength="50" value="<?php echo $row['pro_cs27'];?>"></td>
						<td>建筑面积：</td>
						<td><INPUT name="pro_cs28" type="text" id="pro_can4"  maxlength="50" value="<?php echo $row['pro_cs28'];?>"></td>
					</tr>
					<tr>
						<td>开 发 商：</td>
						<td><INPUT name="pro_cs29" type="text" id="pro_can3"  maxlength="50" value="<?php echo $row['pro_cs29'];?>"></td>
						<td>物业类型：</td>
						<td><INPUT name="pro_cs30" type="text" id="pro_can4"  maxlength="50" value="<?php echo $row['pro_cs30'];?>"></td>
					</tr>
					<tr>
						<td>绿 化 率：</td>
						<td><INPUT name="pro_cs31" type="text" id="pro_can3"  maxlength="50" value="<?php echo $row['pro_cs31'];?>"></td>
						<td>占地面积：</td>
						<td><INPUT name="pro_cs32" type="text" id="pro_can4"  maxlength="50" value="<?php echo $row['pro_cs32'];?>"></td>
					</tr>
				</table></td>
		</tr>
		<tr class="tdbg">
		...
		<tr class="tdbg">
			...
			<td><script id="editor" name="z_body" type="text/plain" style="width:700px;height:400px;"><?php echo $row['z_body'];?></script></td>
		</tr>
		<tr class="tdbg">
