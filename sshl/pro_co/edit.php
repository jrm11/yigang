...
<br />
<FORM name="form1" id="form1" method="post" action="editt.php" onSubmit="return check()" class="form1">
	...
	<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
		...
		<tr class="tdbg">
			...
			<td><select name="lm" id="lm">
					<option value="1">选择房源分类</option>
					<option value="46" selected=" <?php if($row['lm']==46){ echo 'selected';}?>">深圳二手房源</option>
					<option value="50" selected=" <?php if($row['lm']==50){ echo 'selected';}?>">深圳二手学区房</option>
		...
		<tr class="tdbg2">
			...
			<td><table border="0" cellspacing="0" cellpadding="2">
					...
					<tr>
						<td>售价：</td>
						<td><INPUT name="pro_cs43" type="text" id="pro_can3"  maxlength="50" value="<?php echo $row['pro_cs43']; ?>">
							万</td>
						<td>每平米售价：</td>
